CHECKPOINT_PATH=/l/users/amirbek.djanibekov/master-thesis/models/adapters/speechqformer_fairseq/checkpoints/hubertbase/pretrain_gpt/checkpoint_best.pt
