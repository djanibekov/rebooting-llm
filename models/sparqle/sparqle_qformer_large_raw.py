...
from models.sparqle.utils import SparQLeBase, SparQLePretrainOutput
...
@register_model("speech_qformer_large")
@register_model("speech_qformer")  # speech_qformer_large
class Blip2QformerLarge(SparQLeBase):
