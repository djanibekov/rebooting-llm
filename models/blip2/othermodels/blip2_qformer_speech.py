...
@register_model("speech_qformer_speech")
class Blip2QformerCE(Blip2Base):
    ...
    def forward(self, samples):
        ...
        codes = self.speech_encoder.encode(speech.unsqueeze(1), 1)
        ...
        text_output = self.Qformer.bert.embeddings(
    ...
    def generate(
        ...
        lm_outputs = self.Qformer.cls(query_output[0])
...
@register_model_architecture(model_name="speech_qformer_speech", arch_name="speech_qformer_speech")
