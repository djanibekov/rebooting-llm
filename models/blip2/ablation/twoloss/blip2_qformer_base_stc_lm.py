...
@register_model("speech_qformer_base_stc_lm")
class Blip2QformerBaseSTCLM(Blip2Base):
...
@register_model_architecture(model_name="speech_qformer_base_stc_lm", arch_name="speech_qformer_base_stc_lm")
