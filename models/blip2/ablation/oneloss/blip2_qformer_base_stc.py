...
@register_model("speech_qformer_base_stc")
class Blip2QformerBaseSTC(Blip2Base):
...
@register_model_architecture(model_name="speech_qformer_base_stc", arch_name="speech_qformer_base_stc")
