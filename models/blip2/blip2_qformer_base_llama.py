...
@register_model("speech_qformer_base_llama")
class Blip2LLama(Blip2Base):
    ...
    def forward(self, samples):
        ...
        inputs_embeds = self.llama_model.model.embed_tokens(gpt_tokens.input_ids)
...
@register_model_architecture(model_name="speech_qformer_base_llama", arch_name="speech_qformer_base_llama")
